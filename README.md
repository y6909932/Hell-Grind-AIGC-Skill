...
本仓库中由项目所有者创作的代码、文档、模板和示例采用 [CC0 1.0 Universal](./LICENSE) 公共领域奉献：可以自由复制、修改、再分发和商业使用，无需署名。

CC0 仅适用于项目所有者有权授权的内容，不授予第三方商标、专利或《Hell Grind》原始材料的权利。具体边界见 [NOTICE](./NOTICE.md)。
